...
\newcommand{\source}[1]{\caption*{\textcolor{blue}{Źródło: {#1}}} }
...
\begin{figure}[h]
	...
	\caption{Przykład koncepcyjnego zestawienia BOM w formie grafu}
	\source{https://logistykanalogike.wordpress.com/2014/12/18/struktura-wyrobu/}
...
\begin{figure}[h]
	...
	\caption{Przykład zestawienia BOM w formie tabeli}
	\source{https://www.unleashedsoftware.com/blog/everything-you-need-to-know-about-bill-of-materials}
...
\begin{figure}[h]
	...
	\caption{Przykład zestawienia BOM w formie drzewa hierarchicznego}
	\source{https://underthehood-autodesk.typepad.com/blog/items/page/2/}
...
Sekcję rozwiązania podzielono na 4 części: zalecenia, założenia, opis, uruchomienie. Pierwsza z~nich ogólnie przedstawia wyobrażenie idealnego systemu. Założenia są efektem podjęcia decyzji odnośnie wyboru technologii, która umożliwi realizację celu. Ostatnia z~części krótko omawia sposób uruchomienia aplikacji.
...
Na zdjęciu (\ref{fig:app:bom_edit_item}) pokazano edytowanie obiektu za pomocą formularza. Wszelkie parametry są ładowane według bieżących danych, a użytkownik może modyfikować wybrane pola. Tutaj oczywiście również jest walidacja poprawności wpisywanych danych, a~także sprawdzenie integralności identyfikatora, przy czym identyfikator może pozostać niezmieniony. 
...
W celu uruchomienia aplikacji należy ją pobrać ze zdalnego repozytorium \url{https://github.com/Coolxer/BOMPY} i rozpakować w dowolnym miejscu.

Do uruchomienia aplikacji niezbędne jest posiadanie interpretera Python i wbudowanej biblioteki tkinter (instalowana automatycznie wraz z interpreterem o ile nie odznaczono tej opcji).

W katalogu głównym aplikacji znajduje się plik \textbf{main.py}, który należy uruchomić przy pomocy interpretera.

Jeśli wszystko wykonano prawidłowo na ekranie powinno się wyświetlić okno graficzne aplikacji, w przeciwnym wypadku należy rozwiązać wyświetlone błędy.
